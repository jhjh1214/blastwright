...
metadata were used to choose bright, major-key pieces; **nobody has listened**. Check the Output for one
`[Audio] ... OK` line per track. Shuffled with 3s crossfades; about 35 minutes before repeating.
