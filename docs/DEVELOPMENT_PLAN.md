...
- 7 built as configuration and server plumbing (all ids nil, unseen in Studio): product ladder (5-25, 49-99, 149-299, 399-799, 999+ Robux), cosmetic-first shop, bundles, Club subscription, all via the existing ProcessReceipt path with IDs left nil until the developer creates them. Never gate core play; no purchase prompts mid-run.
