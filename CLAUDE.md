...
- Done and unit-tested (256 tests, three charge types): `ChainSim`, `Seam`, `Schema`, `Validate`.
...
- Also new, unseen: bottom-right StatusDock (event tiles with icons + Server Goal tile), area-name banner that fades (E19), hub trophy hall (`Client/Trophies.luau`), combat-linked daily/weekly objectives (Slays, Critical), docs/PUBLISH_GUIDE.md. TESTING.md section E18.
